...
Begin VB.UserControl CommonDialog 
   ...
   ScaleMode       =   0  'User
   ScaleWidth      =   480
   ToolboxBitmap   =   "CommonDialog.ctx":030A
End
...
Public Property Get IconSize() As CommonDialog_IconSize
  If mIconSize <> IconSizeLarge And mIconSize <> IconSizeSmall Then _
mIconSize = IconSizeLarge
  IconSize = mIconSize
End Property
...
Public Function ShowObjectProp(Optional ByVal sObjectName As String, _
Optional ByVal sTab As String)
  Dim uFlag As Long, sObj As String
  Dim sPath As String
  uFlag = mFlags And (&H100 Or &H200 Or &H300 Or &H400 Or &H500 Or &H600 _
Or &H700 Or &H800 Or &H900)
  uFlag = uFlag / 256
  Select Case uFlag
     Case 1, 2
          sObj = sObjectName
...
Private Sub InitOFN()
  ...
  Dim uFlag As Long
  uFlag = mFlags And (&H1 Or &H2 Or &H4 Or &H8 Or &H10 Or &H100 Or &H200 _
Or &H400 Or &H800 Or &H1000 Or &H2000 Or &H4000 Or &H8000 Or &H40000 Or _
&H80000 Or &H100000 Or &H200000)
  With OFN
       .lStructSize = Len(OFN)
       .hwndOwner = mhOwner
       .flags = uFlag
...
Public Sub ShowFont()
  ...
  Dim x As Long
  Dim uFlag As Long
  uFlag = mFlags And (&H1 Or &H2 Or &H3 Or &H4 Or &H100 Or &H200 Or &H400 _
Or &H800 Or &H1000 Or &H2000 Or &H4000 Or &H8000 Or &H10000 Or &H20000 Or _
&H40000 Or &H80000 Or &H100000 Or &H200000)
...
Public Sub ShowPrinter()
  ...
  Dim uFlag As Long
  uFlag = mFlags And (&H0 Or &H1 Or &H2 Or &H4 Or &H8 Or &H10 Or &H20 Or _
&H40 Or &H80 Or &H100 Or &H200 Or &H400 Or &H800 Or &H40000 Or &H80000 Or _
&H100000)
    With PD
      .lStructSize = Len(PD)
      .hwndOwner = mhOwner
    ...
    End With
    With Printer
     DN.extra = .DriverName & vbNullChar & .DeviceName & vbNullChar & _
Port & vbNullChar
    End With
    ...
    Else
       ...
       NewPrinterName = UCase$(left(DM.dmDeviceName, _
InStr(DM.dmDeviceName, vbNullChar) - 1))
...
Sub ShowOpenMultiSelect(fOwner As Form)
Dim tmp() As String
...
On Error Resume Next
    ...
    fOwner.filenames = ""
    Me.FileName = ""
    SetControlOnDlg fOwner
    Me.flags = cdlOFNExplorer Or cdlOFNAllowMultiselect
    Me.ShowOpen
    If GetAttr(Me.FileName) = vbDirectory Then
        Folder = Me.FileName & "\"
    Else
        fOwner.filenames = Me.FileName
    End If
    tmp = Split(fOwner.filenames, Chr(34))
    For i = LBound(tmp) To UBound(tmp)
        If tmp(i) <> "" And tmp(i) <> " " Then allfiles = Folder & tmp(i): Exit For
    Next i
    For i = i + 1 To UBound(tmp)
        If tmp(i) <> "" And tmp(i) <> " " Then tmp(i) = Folder & tmp(i)
        If tmp(i) <> "" And tmp(i) <> " " Then allfiles = allfiles & "|" & tmp(i)
    Next i
    Files = Split(allfiles, "|")
End Sub

Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    'Call PropBag.WriteProperty (Me.
End Sub
